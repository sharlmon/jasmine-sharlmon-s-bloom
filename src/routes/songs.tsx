    ...
    <div className="min-h-screen bg-[#ffed4a] p-8 font-sans" style={{ fontFamily: '"Comic Sans MS", "Chalkboard SE", sans-serif' }}>
      <div className="max-w-2xl mx-auto bg-white border-4 border-black rounded-[2rem] p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
        <div className="flex justify-between items-center mb-8 border-b-4 border-black pb-4">
          ...
          <Link to="/" className="flex items-center gap-2 px-6 py-3 bg-[#33ccff] border-4 border-black rounded-2xl font-black text-lg shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:translate-y-[2px] hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:bg-[#20bdf0] transition-all transform hover:scale-105 active:scale-95">

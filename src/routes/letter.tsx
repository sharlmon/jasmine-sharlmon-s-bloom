      ...
      <div className="max-w-2xl mx-auto bg-white border-4 border-black rounded-[2rem] p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8 border-b-4 border-black pb-4">
          ...
          <div className="flex flex-wrap gap-2">
            <Link to="/" className="flex items-center gap-1.5 px-4 py-2 bg-[#ffed4a] border-4 border-black rounded-2xl font-black text-sm shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:bg-[#ffe500] transition-all active:scale-95">
              🏠 Back to Menu
            </Link>
            <Link 
              to="/" 
